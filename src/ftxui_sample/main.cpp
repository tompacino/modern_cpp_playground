...
// configuration step. It creates a namespace called `modern_cpp_playground`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", modern_cpp_playground::cmake::project_name, modern_cpp_playground::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", modern_cpp_playground::cmake::project_version);
      return EXIT_SUCCESS;
    }
